...
public class ModToolTiers {
    ...
    public static final Tier ROSIUM = new SimpleTier(ModTags.Blocks.INCORRECT_FOR_RAINBOW_TOOL,
            1400, 4f, 3f, 28, () -> Ingredient.of(ModItems.ROSIUM_INGOT));

    public static final Tier LUNARITE = new SimpleTier(ModTags.Blocks.INCORRECT_FOR_RAINBOW_TOOL,
            1400, 4f, 3f, 28, () -> Ingredient.of(ModItems.LUNARITE_INGOT));

    public static final Tier DREAMSTONE = new SimpleTier(ModTags.Blocks.INCORRECT_FOR_RAINBOW_TOOL,
