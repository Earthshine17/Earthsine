...
public class ModConfiguredFeatures {
    ...
    public static void boostrap(BootstrapContext<ConfiguredFeature<?,?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> exampleOre = List.of(OreConfiguration.target(stoneReplacable, ModBlocks.RAINBOW_ORE.get().defaultBlockState()),
                OreConfiguration.target(deepslateReplacable, ModBlocks.RAINBOW_ORE.get().defaultBlockState()));
