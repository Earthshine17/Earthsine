...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?,?>> context) {
        ...
        register(context, OVERWORLD_RAINBOW_ORE, Feature.ORE, new OreConfiguration(rainbowOre, 6));
        register(context, OVERWORLD_ROSIUM_ORE, Feature.ORE, new OreConfiguration(rosiumOre, 6));
        register(context, OVERWORLD_LUNARITE_ORE, Feature.ORE, new OreConfiguration(lunariteOre, 6));
        register(context, OVERWORLD_DREAMSTONE_ORE, Feature.ORE, new OreConfiguration(dreamstoneOre, 6));
    }
